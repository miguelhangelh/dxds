...
import 'package:appdriver/core/model/select_status_model.dart';
import 'package:appdriver/global_widgets/dropdown_with_search.dart';
...
class _CSCPickerState extends State<CSCPicker> {
  ...
  String _selectedState = "Departamento";
  var responses;
  ...
  void initState() {
    getCounty();
    super.initState();
    if (widget.selectedCity.length > 0) {
      this._selectedCity = widget.selectedCity;
    }
    if (widget.selectedState.length > 0) {
      this._selectedState = widget.selectedState;
    }
    if (widget.selectedCountry.length > 0) {
      this._selectedCountry = widget.selectedCountry;
    }
  }
